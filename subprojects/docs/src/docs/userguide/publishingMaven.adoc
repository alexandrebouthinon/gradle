...
++++
<sample dir="maven-publish/completeExample" id="publishing_maven:pom_customization" title="Customizing the POM file">
...
++++
<sample dir="maven-publish/completeExample" id="publishing_maven:complete_example:sample" title="Publishing a Java library">
    <sourcefile file="build.gradle"/>
</sample>
++++
